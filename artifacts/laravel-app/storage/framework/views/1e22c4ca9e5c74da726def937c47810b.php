...
<?php $component->withAttributes(['title' => 'Dashboard','subtitle' => 'Welcome back, '.e(Auth::user()->name).'']); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($totalEmployees); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($totalManagers); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($completedCount); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($pendingCount); ?></p>
                </div>
    ...
    <div class="mb-6 bg-indigo-50 border border-indigo-200 rounded-xl p-4 flex items-center gap-3">
        ...
        <div>
            <p class="text-sm font-medium text-indigo-900">Active Cycle: <?php echo e($activeCycle->name); ?></p>
            <p class="text-xs text-indigo-600"><?php echo e($activeCycle->start_date->format('M d, Y')); ?> – <?php echo e($activeCycle->end_date->format('M d, Y')); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="bg-white rounded-xl border border-gray-200">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('appraisals.index')); ?>" class="text-sm text-indigo-600 hover:underline">View all</a>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-5 py-3 text-gray-600"><?php echo e($appraisal->final_rating ? number_format($appraisal->final_rating, 1) : '—'); ?></td>
...
<?php endif; ?>
<?php /**PATH /home/runner/workspace/artifacts/laravel-app/resources/views/dashboard/admin.blade.php ENDPATH**/ ?>