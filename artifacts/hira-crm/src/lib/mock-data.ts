...
export function getStatusColor(status: 'open' | 'engaged' | 'pending' | 'resolved' | 'closed') {
  switch (status) {
    case 'open': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300';
    case 'engaged': return 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300';
